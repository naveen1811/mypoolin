"""
Django settings for mypoolin project.
...
SECRET_KEY = '$2qqlpk$aaf9m=t*vuf2=rzh2746^=oxtgs1s#ws+=n4kyns%d'
...
ROOT_URLCONF = 'mypoolin.urls'

WSGI_APPLICATION = 'mypoolin.wsgi.application'
